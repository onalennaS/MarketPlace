...
from .views.product_views import add_product as api_add_product, delete_product, edit_product as ep, add_extras, delete_extras, add_addons, delete_addon, activate_product, deactivate_product
...
urlpatterns = [
    ...
    path('api/activate_product/', activate_product, name='api_activate_product'),
    path('api/deactivate_product/', deactivate_product, name='api_deactivate_product'),
